...
class GraphCtrl extends MetricsPanelCtrl {
  ...
  onInitPanelActions(actions) {
    actions.push({text: 'Export to Excel (series as rows)', click: 'ctrl.exportXML()'});
    actions.push({text: 'Export to Excel (series as columns)', click: 'ctrl.exportXMLColumns()'});
  ...
  exportXML() {
    fileExport.exportSeriesListToXML(this.seriesList);
  }

  exportXMLColumns() {
    fileExport.exportSeriesListToXMLColumns(this.seriesList);
  }
